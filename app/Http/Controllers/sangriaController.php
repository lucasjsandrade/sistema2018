    ...
    public function index(Request $request)
    {
        ...
        if ($request) {
            ...
            $caixa = DB::table('caixa as c')
                ...
                -> join('movimentacaocaixa as movimen', 'movimen.idcaixa','=','c.idcaixa')

                -> select ('c.idcaixa', 'c.data', 'movimen.sangria', 'c.saldoAtual')
                -> where ('movimen.sangria' ,'<>', 0)

                ->orderBy('idcaixa', 'desc')
                ->paginate(10);
            return view('sangria.index', [
