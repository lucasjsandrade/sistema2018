...
class ContasreceberController extends Controller
{
	...
	public function index(Request $request){
		...
		if($request){
			...
			->select('ven.idvenda','cli.idcliente','ven.numeroDeParcelas','c.idcontasr', 'c.data','c.descricao','c.valor')			
			...
			->groupBy ('ven.idvenda','cli.idcliente','ven.numeroDeParcelas','c.idcontasr', 'c.data','c.descricao','c.valor')
	...
	/*public function create(){
		...
		public function show($id){
			...
			->select('parc.idparcela','parc.dataVencimento','valorParcela','parc.idcontasr')
			->where('cr.idcontasr', '=',$id)
			->get();
