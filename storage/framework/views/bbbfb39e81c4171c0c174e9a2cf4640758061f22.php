...
<html>
  <head>
    ...
    <title>Percianas Capricho</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="/estoque/categoria"><i class="fa fa-circle-o"></i> Categorias</a></li>
                 <li><a href="/estoque/marca"><i class="fa fa-circle-o"></i> Marca</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/regiao/pais"><i class="fa fa-circle-o"></i> País</a></li>
                <li><a href="/regiao/estado"><i class="fa fa-circle-o"></i> Estado</a></li>
                <li><a href="/regiao/cidade"><i class="fa fa-circle-o"></i> Cidade</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#">
               ...
               <ul class="treeview-menu">
              <li><a href="/pessoa/fornecedor"><i class="fa fa-circle-o"></i>Fornecedor</a></li>
              <li><a href="/pessoa/cliente"><i class="fa fa-circle-o"></i>Cliente</a></li>
              <li><a href="/pessoa/funcionario"><i class="fa fa-circle-o"></i>Funcionario</a></li>
              </ul>
            </li>    
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema Percianas Capricho</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Estagio Supervisionado <a </a>.</strong> 3 Ano.
      </footer>
