<?php $__env->startSection('conteudo'); ?>
    ...
    <?php echo Form::open(array('url'=>'/pdf/CaixaGetPDF','method'=>'POST','autocomplete'=>'off')); ?>
    ...
    <div class="row">
        <div class="col-lg-2 col-sm-2 col-xs-2">
            <div class="form-group">
                ...
                <span class="ob">*</span>
                <input validaData type="date" name="dataInicial" required value="<?php echo e(old('dataInicial')); ?>"
                       class="form-control">
            </div>
        </div>
        ...
        <div class="col-lg-2 col-sm-2 col-xs-2">
            <div class="form-group">
                ...
                <span class="ob">*</span>
                <input validaData type="date" name="dataFinal" required value="<?php echo e(old('dataFinal')); ?>"
                       class="form-control">
            </div>
        </div>
