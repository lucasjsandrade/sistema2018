<?php $__env->startSection('conteudo'); ?>
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <h3>Novo Orcamento de Venda <a href="/venda/orcamento/create">
                ...
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <?php $__currentLoopData = $venda; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(URL::action('orcamentoController@show',$o->idvenda)); ?>">
                                    <button class="btn btn-info">Detalhe</button>
                                </a>
                                <a href="<?php echo e(URL::action('orcamentoController@edit',$o->idvenda)); ?>">
