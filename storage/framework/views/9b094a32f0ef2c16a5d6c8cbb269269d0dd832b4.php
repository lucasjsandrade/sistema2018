<?php echo Form::open(array('url'=>'venda/agendamento', 'method'=>'GET', 'autocomplete'=>'off', 'role'=>'search')); ?> <!--Comando para inicializar um formulario, coloca array porque vai abrir uma lista de repetição-->
