...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Usuario   <a href="seguranca/usuario"><button class="btn btn-success">Incluir</button></a></h3>
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td>
						<a href="<?php echo e(URL::action('usuarioController@edit',$user->id)); ?>"><button class="btn btn-info">Alterar</button></a>
