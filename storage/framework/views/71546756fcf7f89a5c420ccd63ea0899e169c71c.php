...
<?php echo Form::open(array('url'=>'compra','method'=>'POST','autocomplete'=>'off')); ?>
  ...
  <div class="col-lg-12 col-sm-12 col-md-12  col-xs-12">
    <table id="detalhes" class="table table-striped table-bordered table-condensed table-hover">
      ...
      <tfoot>
        ...
        <td>
          <input type="text" name="totalCompra" readonly id="total" class="form-control" style="width: 100px;">
        </td>     
      </tfoot>   
    </tfoot>
  </table>
