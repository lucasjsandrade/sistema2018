...
<div class="col-lg-12 col-sm-12 col-md-12  col-xs-12">
  <table id="detalhes" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <tbody>
           ...
           <td>
            <input class="form-control" disabled name="idproduto[]" value="<?php echo e($itens->idproduto); ?>">
          </td>
          <td>
            <input class="form-control" disabled name="quantidade[]" value="<?php echo e($itens->quantidade); ?>">
          </td>  

          <td>
            <input class="form-control" disabled name="valorUnitario[]" value="<?php echo e($itens->valorUnitario); ?>">
          </td>
        
        <td>
          <input class="form-control" disabled name="valorTotal[]" value="<?php echo e($itens->valorTotal); ?>">
