...
<?php echo Form::open(array('url'=>'venda/venda','method'=>'POST','autocomplete'=>'off')); ?>
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="salvar">
  <div class="form-group">
   ...
   <button class="btn btn-danger" type="reset"  onclick="javascript: location.href='/venda/venda';">Cancelar</button>
 </div>
</div>
