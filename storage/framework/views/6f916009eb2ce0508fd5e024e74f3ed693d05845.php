<?php $__env->startSection('conteudo'); ?>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <?php echo Form::open(array('url'=>'suprimento','method'=>'POST','autocomplete'=>'off','files'=>'true')); ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <span class="ob">*</span>
                        <input type="number" name="suprimento" required value="<?php echo e(old('suprimento')); ?>" class="form-control"
