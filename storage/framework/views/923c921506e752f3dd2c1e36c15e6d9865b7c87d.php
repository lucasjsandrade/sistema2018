            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              ...
              <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="number" name="telefone" required value="<?php echo e($fornecedor->telefone); ?>"class="form-control" placeholder="Telefone">
                 </div>
              </div>
               ...
               <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="number" name="fax" value="<?php echo e($fornecedor->fax); ?>" class="form-control" placeholder="Fax">
                 </div>
              </div>
               ...
               <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="number" name="whatsapp" value="<?php echo e($fornecedor->whatsapp); ?>" class="form-control" placeholder="Whatsapp">
                 </div>
              </div>
